...
def run_causal_intervention(checkpoint_dir: str, token_a: str, token_b: str, context: str, num_samples: int, receiver_dist_min: int = 10, alarm_test: bool = False):
    ...
    # under phase14_transcendental (which has none named "hidden_dim") — this
    # always missed and silently fell through to the hardcoded 128, matching
    # today's value by coincidence. Read the real key, same as main_jax.py.
